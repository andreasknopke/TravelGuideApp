...
import { AVAILABLE_INTERESTS, getInterests, saveInterests } from '../services/interests.service';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.infoCard}>
          <Text style={styles.infoLabel}>{t('dataSources')}</Text>
          <Text style={styles.infoValue}>Wikitravel API & LLM</Text>
        </View>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{t('aboutThisApp')}</Text>
